...
export const fileService = {
  uploadFile: async (groupId: number, file: File): Promise<FileUpload> => {
    ...
    // Unset Content-Type so axios lets the browser set multipart/form-data with the correct boundary.
    // The axios instance defaults to application/json which breaks FormData uploads.
