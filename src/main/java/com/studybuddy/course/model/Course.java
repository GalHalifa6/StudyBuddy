package com.studybuddy.course.model;
...
public class Course {
    ...
    private Set<com.studybuddy.user.model.User> students = new HashSet<>();

    @OneToMany(mappedBy = "course", cascade = CascadeType.ALL)
    private Set<com.studybuddy.group.model.StudyGroup> groups = new HashSet<>();
}
