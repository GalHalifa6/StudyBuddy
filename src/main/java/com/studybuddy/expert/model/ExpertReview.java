...
public class ExpertReview {
    ...
    private com.studybuddy.expert.model.ExpertSession session; // Optional - review can be from a session

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "question_id")
    @JsonIgnoreProperties({"student", "expert", "followUpQuestions"})
    private com.studybuddy.expert.model.ExpertQuestion question; // Optional - review can be from Q&A
