...
public class ExpertQuestion {
    ...
    @JsonIgnoreProperties({"groups", "createdGroups", "courses", "messages", "files", "password", "profileEmbedding"})
    private com.studybuddy.user.model.User expert; // Can be null initially if question is open to all experts
    ...
    private com.studybuddy.group.model.StudyGroup studyGroup;
