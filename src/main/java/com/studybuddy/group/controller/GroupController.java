package com.studybuddy.group.controller;
...
public class GroupController {
    ...
    public ResponseEntity<?> getGroupById(@PathVariable Long id) {
        ...
        boolean isCreator = group.getCreator() != null && group.getCreator().getId().equals(currentUser.getId());
    ...
    public ResponseEntity<?> joinGroup(@PathVariable Long id) {
        ...
        if (user.getGroups() != null && user.getGroups().contains(group)) {
        ...
        if (memberCount >= group.getMaxSize()) {
    ...
    public ResponseEntity<?> inviteUser(@PathVariable Long id, @RequestBody Map<String, Object> body) {
        ...
        if (invitedUser.getGroups() != null && invitedUser.getGroups().contains(group)) {
    ...
    public ResponseEntity<?> acceptRequest(@PathVariable Long requestId) {
        ...
        if ("JOIN_REQUEST".equals(request.getRequestType())) {
            if (request.getGroup().getCreator() == null || !request.getGroup().getCreator().getId().equals(currentUser.getId())) {
        ...
        // Check capacity
        if (group.getMembers() != null && group.getMembers().size() >= group.getMaxSize()) {
            return ResponseEntity.badRequest().body(Map.of("message", "Group is full"));
        }
