...
public class QuizAdminController {
     ...
     */
    @GetMapping("/config")
    public ResponseEntity<com.studybuddy.quiz.model.QuizConfig> getConfig() {
        log.info("Admin fetching quiz configuration");
        com.studybuddy.quiz.model.QuizConfig config = quizService.getQuizConfig();
     ...
     */
    @PutMapping("/config")
    public ResponseEntity<com.studybuddy.quiz.model.QuizConfig> updateConfig(
        ...
        com.studybuddy.quiz.model.QuizConfig config = quizService.updateQuizConfig(request.getSelectedQuestionIds());
        return ResponseEntity.ok(config);
    }
